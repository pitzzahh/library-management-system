...
public final class Validator {
    ...
    public static boolean doesAccountExist(String accountNumber) {
        ...
        else if (accountNumber.length() != MAX_LENGTH && isWholeNumber().test(accountNumber)) throw new IllegalArgumentException(format("Student number must be %d digits long", getMaxInputLength()));
